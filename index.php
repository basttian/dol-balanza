...
function Search2(keyCodeForEnter, moreorless) {
	...
	if (search === true) {
		...
		search2_timer = setTimeout(function(){
          ...
          /**********************************************************************************************//////////////////////////////////
          /**********************************************************************************************//////////////////////////////////
					//AGREGADO CODIGO BALANZA DIGITAL 
					else if ($('#search').val() == data[0]['barcode'] && 'balancode' == data[0]['object']) {
						ClickProduct(0);
					}
					else if ($('#search').val() != data[0]['barcode'] && 'balancode' == data[0]['object']) {
						ChangeQtyBalanzaDigital(data[0]['rowid'],data[0]['qtycode']);
					}
          /**********************************************************************************************//////////////////////////////////
          /**********************************************************************************************//////////////////////////////////
          /**********************************************************************************************//////////////////////////////////
...
/******************************************************************************************************///////////////////////
/**********************************************************************************************//////////////////////////////////
//ACTUALIZAR CANTIDAD MMMMM..
 function ChangeQtyBalanzaDigital(id,qty) {
 	//console.log(id,qty);
